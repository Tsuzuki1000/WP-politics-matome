<?php get_header(); ?>
    <div id="hero">
      <img src="<?php echo esc_url(get_theme_file_uri('img/illust.jpg')); ?>" alt="ヒーロー">
    </div>
  ...
  <?php get_sidebar('left'); ?>
      <main>
        ...
        <article>
          ...
          <img src="<?php echo esc_url(get_the_post_thumbnail_url()) ; ?>" alt="サムネイル">
          <div class="text">
            <?php the_excerpt(); ?>
          </div>
          <div class="btn-wrap">
            <a href="<?php echo esc_url(get_the_permalink()); ?>" class="btn">続きを読む</a>
          </div>
        </article>
        <?php endwhile; ?>
        <?php endif; ?>
